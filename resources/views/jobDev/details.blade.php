                    ...
                    <div class="flex flex-wrap">
                        ...
                        @foreach ($userTecno as $tec)
                            <div
                                ...
                                <div class="flex items-center justify-center w-12 bg-indigo-400">
        ...
        <div class="items-center px-10 -mx-10 md:flex ">
            ...
            <div class="flex-1">
                ...
                <div class="mt-6 ">
                    ...
                    <a href="/ofertas"><button
                            class="px-20 py-3 mt-4 mx-20 font-semibold text-white bg-indigo-400 rounded-full opacity-75 hover:opacity-90 hover:text-blue-900 focus:outline-none"><i
            ...
            <div class="mt-6 ">
                <form action="{{route('applications.store')}}" method="POST">
                    ...
                    <button 
                        type=submit
                        class="px-20 py-3 mx-20 font-semibold text-white bg-indigo-400 rounded-full opacity-75 hover:opacity-90 hover:text-blue-900 focus:outline-none"><i
