...
$classes = ($active ?? false)
            ? 'block pl-3 pr-4 py-2 border-l-4 border-indigo-400 text-base font-medium text-blue-700 bg-indigo-50 focus:outline-none focus:text-blue-800 focus:bg-indigo-100 focus:border-indigo-700 transition'
