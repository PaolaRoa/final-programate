...
@section('content')
    ...
    <h2 class="text-xl text-center text-indigo-500 mt-8">Crear Vacante</h2>


    <form action="/vacante" method="POST" autocomplete=”off”>
        @csrf
        <div class="relative w-full mb-3">
            <label for="" class="p-2 text-indigo-500">Titulo</label>
        ...
        <div class="relative w-full mb-3">
            <label for="" class="p-2 text-indigo-500">Experiencia requerida</label>
        ...
        <div class="relative w-full mb-3">
            <label for="" class="p-2 text-indigo-500">Salario</label>
        ...
        <div class="relative w-full mb-3">
            <label for="" class="p-2 text-indigo-500">Lugar</label>
        ...
        <div>
            <label for="" class="p-2 text-indigo-500">Moneda</label>
        ...
        <div class="relative w-full mb-3">
            <label for="" class="p-2 text-indigo-500">Descripcion de la vacante</label>
        ...
        <div>
            <label for="" class="p-2 text-indigo-500">Tecnologias requeridas</label>
            <style>
                [x-cloak] {
                    display: none;
                }
            ...
            {{-- estado --}}
            <div>
                <label for="" class="p-2 text-indigo-500">Estado de la vacante</label>
                <div class="flex flex-col w-full h-auto mx-auto md:w-1/2">
