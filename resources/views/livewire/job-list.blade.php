<div class="justify-center py-6 my-6">
    <img src="favicons/officium.png" alt="officium" class="h-16 m-auto">
    <h1 class="py-6 my-6 text-2xl  leading-tight text-center">Somos la plataforma N° 1 para encontrar el mejor trabajo y el mejor talento</h1>

    <h2 class="text-center text-3xl font-bold">Últimas ofertas</h2>
</div>
