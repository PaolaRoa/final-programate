...
@section('content')
    ...
    <h2 class="text-xl text-center text-indigo-500">Editar Vacante</h2>

    <form action="/vacante/{{ $vacante->id }}" method="POST">
        @csrf
        @method('PUT')
        <div class="relative w-full mb-3 text-xl">
            <small class="p-2 text-indigo-500">* Titulo</small>
        ...
        <div class="relative w-full mb-3 text-xl">
            <small class="p-2 text-indigo-500">* Experiencia requerida</small>
        ...
        <div class="relative w-full mb-3 text-xl">
            <small class="p-2 text-indigo-500">* Salario</small>
        ...
        <div class="relative w-full mb-3 text-xl">
            <small class="p-2 text-indigo-500">* Lugar</small>
        ...
        <div>
            <small class="p-2 text-xl text-indigo-500">* Moneda</small>
            <div class="flex flex-col w-full h-64 mx-auto md:w-1/2">
                <select name="currency" id="currency"
                    ...
                    <div class="w-full bg-indigo-400 border-b border-gray-100 rounded-t cursor-pointer hover:bg-teal-100">
        ...
        <div class="relative w-full mb-3 text-xl">
            <small class="p-2 text-indigo-500">* Descripcion de la vacante</small>
        ...
        <div>
            <small class="p-2 text-xl text-indigo-500">* Estado</small>
            <div class="flex flex-col w-full h-64 mx-auto md:w-1/2">
        ...
        <div>
            <small class="p-2 text-xl text-indigo-500">* Actuales</small>
                ...
                @foreach ($userTecno as $tec)
                    <div
                        ...
                        <div class="px-4 py-2 -mx-3">
                            <div class="mx-3">
                                <span class="font-semibold text-indigo-500 dark:text-blue-400">
                                    {{ $tec->tecno }}</span>
                            </div>
                        </div>
                    </div>
        ...
        <div>
            <small class="p-2 text-xl text-indigo-500">*Editar</small>
            <style>
                [x-cloak] {
                    display: none;
                }
                                        ...
                                        <div
                                            ...
                                            <div class="flex flex-row-reverse flex-auto">
                                                <div x-on:click="remove(index,option)">
                                                    <svg class="w-6 h-6 rounded-full fill-current hover:bg-indigo-200 "
