...
@section('content')
    ...
    <section class="p-8 bg-indigo-dark h-50">
        <h1 class="text-center text-green-500 text-bold">Ofertas disponibles</h1>
    ...
    @if (sizeof($jobsDevs)==0)
        <h2 class="text-center text-green-500">Tu busqueda no arrojo resultados</h2>
        ...
        @foreach ($jobsDevs as $jobDev)
            ...
            <a href="{{ route('jobdetail', [$jobDev->Title, $jobDev->id]) }}">
                <div class="mb-2 border border-gray-400 rounded-lg shadow lg:flex">
                    <div class="block h-full py-1 bg-indigo-600 rounded-lg shadow-inner lg:w-2/12">
